...
import com.yandex.taskmanager.model.TaskManager;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Task buyGroceriesToUpdate = new Task(buyGroceries.getId(), "Купить продукты", "Можно и без молока", Status.IN_PROGRESS);
        ...
        Subtask moveApartmentsSubtask1 = new Subtask("Упаковать вещи", "Обязательно не забыть документы", moveApartments.getId());
        Subtask moveApartmentsSubtask2 = new Subtask("Заказать грузчиков", "Старую мебель продать на Авито", moveApartments.getId());

...
public class TaskManager {
    ...
    // Мапы для хранения задач, эпиков и подзадач
    ...
    public Epic updateEpic(Epic epic) {
        ...
        // Удаляем подзадачи из мапы подзадач, если они были у старого эпика
        ...
        // Добавляем подзадачи в мапу подзадач, если они есть у нового эпика
